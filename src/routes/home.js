...
function Home() {
  ...
  const mobileItem = {
    hidden: { y: 0, opacity: 0, rotate: 0, pathLength: 0, pathSpacing: .1, transition: {delay: 0} },
    visible: { y:0, opacity: 1, rotate: 0, pathLength: 1, pathSpacing: 0, transition: {delay: 0, duration: 1} }
  };

  const yUp = {
    hidden: { x:0, y: -30, opacity: 0, transition: {delay: 0} },
    visible: { x:0, y: -45, opacity: 1, transition: {delay: .3, duration: .8} }
  };

  const yDown = {
    hidden: { x:0, y: -15, opacity: 0, transition: {delay: 0} },
    visible: { x:0, y:0, opacity: 1, transition: {delay: .8, duration: .8} }
  };
      ...
      >
        ...
        <div className='text-center flex-md-equal justify-content-center center-bg'>
          ...
          <motion.svg
            ...
            fill="none" 
            xmlns="http://www.w3.org/2000/svg">
            <motion.path initial="hidden" animate="visible" variants={mobileItem} d="M386.869 0.499998C366.053 20.7518 351.495 41.2771 343.25 57.2272C313.214 110.335 221.016 215.766 92.5129 212.632C57.3787 211.775 26.7807 219.88 0.5 233.311" stroke="#272727"/>
            <motion.path initial="hidden" animate="visible" variants={mobileItem} d="M231.431 0.49999C188.257 54.5031 108.844 121.106 6.32211 118.605C4.36738 118.557 2.42669 118.537 0.5 118.545" stroke="#272727"/>
            <motion.path initial="hidden" animate="visible" variants={mobileItem} d="M29.4328 0.500014C20.142 4.92001 10.4915 8.8688 0.5 12.229" stroke="#272727"/>
            <motion.path initial="hidden" animate="visible" variants={mobileItem} d="M309.062 262.5C359.112 228.368 394.591 183.158 411.158 153.865C419.49 137.748 434.268 116.958 455.435 96.5" stroke="#272727"/>
            <motion.path initial="hidden" animate="visible" variants={mobileItem} d="M304.329 0.500017C302.267 3.88548 300.44 7.1353 298.848 10.2146C268.812 63.3221 176.614 168.753 48.1116 165.619C31.198 165.207 15.3356 166.871 0.5 170.207" stroke="#272727"/>
            <motion.path initial="hidden" animate="visible" variants={mobileItem} d="M141.978 0.499994C105.166 32.588 57.1181 61.0426 0.5 69.2732" stroke="#272727"/>
            <motion.path initial="hidden" animate="visible" variants={mobileItem} d="M406.021 262.5C427.437 240.117 443.359 217.832 452.947 200.879C453.74 199.345 454.591 197.77 455.5 196.157" stroke="#272727"/>
            <motion.path initial="hidden" animate="visible" variants={mobileItem} d="M347.111 0.500008C337.386 12.5429 330.001 23.9839 324.968 33.7202C294.931 86.8276 202.733 192.259 74.2307 189.125C46.9542 188.459 22.4117 193.196 0.500977 201.632" stroke="#272727"/>
            <motion.path initial="hidden" animate="visible" variants={mobileItem} d="M192.627 0.500007C149.157 46.2128 82.725 92.6008 0.5 95.0646" stroke="#272727"/>
            <motion.path initial="hidden" animate="visible" variants={mobileItem} d="M249.708 262.5C321.501 228.961 372.082 167.122 392.875 130.358C403.435 109.931 424.348 82.001 455.5 56.7507" stroke="#272727"/>
            <motion.path initial="hidden" animate="visible" variants={mobileItem} d="M272.095 0.499988C235.415 56.1218 147.963 144.993 29.8289 142.112C19.6755 141.864 9.90098 142.365 0.5 143.527" stroke="#272727"/>
            <motion.path initial="hidden" animate="visible" variants={mobileItem} d="M93.4693 0.499996C66.5238 19.055 35.3052 34.4317 0.5 42.3583" stroke="#272727"/>
            <motion.path initial="hidden" animate="visible" variants={mobileItem} d="M363.045 262.5C397.124 233.005 421.692 200.308 434.664 177.372C439.469 168.076 446.418 157.228 455.5 145.785" stroke="#272727"/>
            <motion.path initial="hidden" animate="visible" variants={mobileItem} d="M106.195 262.587C111.949 262.226 117.836 262.11 123.855 262.257C252.358 265.391 344.556 159.96 374.592 106.852C387.115 82.6263 414.202 47.8462 455.659 19.5" stroke="#272727"/>
            <motion.path initial="hidden" animate="visible" variants={mobileItem} d="M7.79102 262.5C35.3325 247.248 67.8358 237.83 105.572 238.75C234.075 241.884 326.273 136.453 356.309 83.3456C368.176 60.3892 393.12 27.9556 430.978 0.500004" stroke="#272727"/>
